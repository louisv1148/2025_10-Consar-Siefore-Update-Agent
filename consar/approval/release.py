...
2. Creates GitHub release with proper title and description
3. Uploads the database file as a release asset
"""
...
from consar.config import (
    APPROVAL_FILE, HISTORICAL_DB, ENRICHED_JSON,
    REPO_OWNER, HISTORY_REPO_NAME, AGENT_REPO_NAME, MONTHS_EN,
)
...
def load_approval_data():
    ...
    if not os.path.exists(APPROVAL_FILE):
        raise FileNotFoundError("No approval file found. Run approval integration first.")
...
Generated by [CONSAR Siefore Agent](https://github.com/{REPO_OWNER}/{AGENT_REPO_NAME})
"""
